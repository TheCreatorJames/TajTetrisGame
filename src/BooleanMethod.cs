...
{
    class BooleanMethod : SingleReturnMethodElement
    {
        private BooleanVariableHolder holderA, holderB;
        ...
        {
            return holderA.GetCode() + " " + holderB.GetCode() + " " + mode;
        }
        ...
        {
            var nOr = new BooleanMethod();
            nOr.holderA = (BooleanVariableHolder)holderA.Clone();
            nOr.holderA = (BooleanVariableHolder)holderB.Clone();
            return nOr;
        }
